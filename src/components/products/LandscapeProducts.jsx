...
export default function LandscapeProducts() {
  ...
  const products = [
    {
      image : 'https://i.ibb.co/cXCRDW9j/image-11.png',
      name: "Antiqo Fence",
      price: "₹10,024.00 – ₹14,984.82"
    },
    {
        image : 'https://i.ibb.co/6JyxwkCw/image-12.png',
      name: "JF Australian Trellis",
      price: "₹6,962.00"
    },
    {
        image : 'https://i.ibb.co/3YPVtW02/image-13.png',
      name: "JF Polyhex Mesh",
      price: "₹4,050.00 – ₹10,770.00"
    },
    {image : 'https://i.ibb.co/vx5W5MdC/image-14.png',
  ...
  return (
    <section className="pt-12">
      <div className="max-w-6xl mx-auto px-4">
        <h2 className="text-2xl md:text-3xl font-medium text-gray-800 mb-5">
          Landscape Products
        </h2>
